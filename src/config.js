...
const config = {
  ...
  qrPageToken: String(process.env.QR_PAGE_TOKEN || '').trim(),
  ...
  playwrightImageFallback: bool(process.env.PLAYWRIGHT_IMAGE_FALLBACK, false),
  ...
  autoPublishAfterCollect: bool(process.env.AUTO_PUBLISH_AFTER_COLLECT, true),
